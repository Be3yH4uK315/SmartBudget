...
def setup_exception_handlers(app: FastAPI) -> None:
    ...
    app.add_exception_handler(
        exceptions.GoalServiceError,
        goal_service_exception_handler,
    )
...
async def goal_service_exception_handler(
    ...
    """Обрабатывает бизнес-ошибки сервиса целей."""
    status_code = _get_goal_error_status_code(exc)
...
def _get_goal_error_status_code(exc: exceptions.GoalServiceError) -> int:
    """Возвращает HTTP-код для бизнес-ошибки сервиса целей."""
