...
def setup_exception_handlers(app: FastAPI) -> None:
    ...
    app.add_exception_handler(
        exceptions.BudgetServiceError,
        budget_service_exception_handler,
    )
...
async def budget_service_exception_handler(
    ...
    """Обрабатывает бизнес-ошибки сервиса бюджетов."""
    status_code = _get_budget_error_status_code(exc)
...
def _get_budget_error_status_code(exc: exceptions.BudgetServiceError) -> int:
    """Возвращает HTTP-код для бизнес-ошибки сервиса бюджетов."""
