...
EVENT_REGISTRY = {
    ...
    "budget.limit.reached_80": EventRouteConfig(
        service=NotificationServiceType.LIMIT, notification_type=NotificationType.ALERT,
    ...
    "budget.limit.exceeded": EventRouteConfig(
        service=NotificationServiceType.LIMIT, notification_type=NotificationType.WARNING,
    ...
    "budget.total.reached_80": EventRouteConfig(
        service=NotificationServiceType.BUDGET, notification_type=NotificationType.ALERT,
        title_key="Budget.preOverflow.title", message_key="Budget.preOverflow.message",
        default_channels=["IN_APP", "PUSH"],
        props=("percent",),
    ),
    "budget.total.exceeded": EventRouteConfig(
        service=NotificationServiceType.BUDGET, notification_type=NotificationType.WARNING,
        title_key="Budget.overflow.title", message_key="Budget.overflow.message",
        default_channels=["IN_APP", "PUSH", "EMAIL"]
    ),
    "budget.settings.changed": EventRouteConfig(
        service=NotificationServiceType.BUDGET, notification_type=NotificationType.INFO,
    ...
    "goal.created": EventRouteConfig(
        service=NotificationServiceType.GOALS, notification_type=NotificationType.SYSTEM,
    ...
    "goal.payment_missed": EventRouteConfig(
        service=NotificationServiceType.GOALS, notification_type=NotificationType.ALERT,
        title_key="Goals.missedPayment.title", message_key="Goals.missedPayment.message",
        default_channels=["IN_APP", "PUSH"],
        props=("goal_id", "name"),
    ),
    "goal.almost_achieved": EventRouteConfig(
        service=NotificationServiceType.GOALS, notification_type=NotificationType.INFO,
        title_key="Goals.almostAchieved.title", message_key="Goals.almostAchieved.message",
        default_channels=["IN_APP"],
        props=("goal_id", "name"),
    ),
    "goal.achieved": EventRouteConfig(
        service=NotificationServiceType.GOALS, notification_type=NotificationType.SUCCESS,
        title_key="Goals.achieved.title", message_key="Goals.achieved.message",
        default_channels=["IN_APP", "PUSH", "EMAIL"],
        props=("goal_id", "name"),
    ),
    "goal.expired": EventRouteConfig(
        service=NotificationServiceType.GOALS, notification_type=NotificationType.WARNING,
    ...
    "transaction.unclassified.found": EventRouteConfig(
        service=NotificationServiceType.TRANSACTIONS, notification_type=NotificationType.INFO,
    ...
    "auth.device.new_login": EventRouteConfig(
        service=NotificationServiceType.SECURITY, notification_type=NotificationType.ALERT,
        title_key="Security.newLogin.title", message_key="Security.newLogin.message",
        default_channels=["IN_APP", "PUSH"]
    ),
    "auth.password.changed": EventRouteConfig(
        service=NotificationServiceType.SECURITY, notification_type=NotificationType.INFO,
    ...
    "auth.activity.suspicious": EventRouteConfig(
        service=NotificationServiceType.SECURITY, notification_type=NotificationType.WARNING,
