...
def setup_exception_handlers(app: FastAPI) -> None:
    ...
    app.add_exception_handler(
        ...
        notification_service_exception_handler,
    )
...
async def notification_service_exception_handler(
    request: Request,
    exc: exceptions.NotificationServiceError,
) -> ORJSONResponse:
    """Обрабатывает бизнес-ошибки сервиса уведомлений."""
    status_code = _get_notification_error_status_code(exc)
...
def _get_notification_error_status_code(
    exc: exceptions.NotificationServiceError,
) -> int:
    """Возвращает HTTP-код для бизнес-ошибки сервиса уведомлений."""
