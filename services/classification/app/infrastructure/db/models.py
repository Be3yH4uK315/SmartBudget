...
class ClassificationSource(str, enum.Enum):
    """Источник результата классификации."""
...
class Rule(Base):
    """Правило классификации транзакций."""
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            ...
            name="ck_rule_priority_range",
        ),
    )


class ClassificationResult(Base):
    """Результат классификации транзакции."""
...
class Feedback(Base):
    """Пользовательский feedback по классификации."""
...
class TrainingDataset(Base):
    """Обучающий датасет для ML pipeline."""
