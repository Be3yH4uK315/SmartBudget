...
def upgrade() -> None:
    ...
    sa.UniqueConstraint('version', name='uq_models_version')
    )
    ...
    sa.UniqueConstraint('version', name='uq_training_datasets_version')
    )
    ...
    sa.UniqueConstraint('transaction_id', name='uq_classification_results_transaction_id')
    )
